...
class PredicateRegistry:
    ...
    def __init__(self):
        ...
        self.performance_justifications: Dict[str, str] = {}  # Predicate -> justification
    ...
    def register_cidsem_counter(self, predicate_name: str, justification: str = "") -> CounterStore:
    ...
    def register_cidsem_multivalue(self, predicate_name: str, justification: str = "") -> MultiValueSetStore:
